...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice competitive soccer and prepare for interschool matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["alex@mergington.edu", "mia@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Train basketball skills and play friendly games",
    ...
    "Drama Club": {
        "description": "Develop acting skills and put on theater productions",
